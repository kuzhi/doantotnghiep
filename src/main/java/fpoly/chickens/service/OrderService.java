...
public interface OrderService {
	...
	Integer countOrderWithStatus(Integer storeid, Date dateStar, Date dateEnd, Integer Status);
	Integer getSaleOrderInDate(Integer storeid, Date dateStar, Date dateEnd, Integer Status);
